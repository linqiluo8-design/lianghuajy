...
INSERT INTO daily_limit_stats (
    ...
    -- 新能源板块龙头（4连板）
    ('2025-12-30', '600001.SH', '宁德时代',
     1, '新能源汽车产业链景气度提升', '电池制造',
     500.00, 550.00, 550.00, 495.00, 500.00,
     10.00, 'limit_up', TRUE, FALSE, FALSE, 0, 4,
     5000000, 2750000000, 5.2, 800000, '09:25:00',
     7500000, 8000000, '新能源,锂电池,储能'),

    -- 新能源2连板
    ('2025-12-30', '600002.SH', '比亚迪',
     1, '新能源车销量超预期', '汽车制造',
     250.00, 275.00, 275.00, 248.00, 250.00,
     10.00, 'limit_up', FALSE, FALSE, FALSE, 0, 2,
     8000000, 2200000000, 8.5, 500000, '09:45:00',
     4500000, 5000000, '新能源,智能驾驶,汽车整车'),

    -- 新能源首板（炸板回封）
    ('2025-12-30', '600003.SH', '隆基绿能',
     1, '光伏订单饱满，业绩超预期', '光伏设备',
     30.00, 33.00, 33.00, 29.50, 30.00,
     10.00, 'limit_up', FALSE, TRUE, TRUE, 1, 1,
     12000000, 390000000, 15.2, 200000, '13:25:00',
     1500000, 2000000, '新能源,光伏,绿色电力'),

    -- 人工智能板块龙头（5连板）
    ('2025-12-30', '300001.SZ', '科大讯飞',
     7, 'AI大模型应用落地，订单爆发', '软件开发',
     60.00, 66.00, 66.00, 59.50, 60.00,
     10.00, 'limit_up', TRUE, FALSE, FALSE, 0, 5,
     6000000, 3960000000, 6.8, 1000000, '09:30:00',
     9000000, 10000000, '人工智能,ChatGPT,语音识别'),

    -- 人工智能3连板
    ('2025-12-30', '300002.SZ', '中科曙光',
     7, 'AI算力需求暴涨，服务器订单增加', '计算机设备',
     40.00, 44.00, 44.00, 39.80, 40.00,
     10.00, 'limit_up', FALSE, FALSE, FALSE, 0, 3,
     4500000, 1980000000, 9.2, 350000, '10:15:00',
     3200000, 3500000, '人工智能,云计算,数据中心'),

    -- 半导体板块2连板
    ('2025-12-30', '688001.SH', '中芯国际',
     2, '芯片国产替代加速', '半导体',
     50.00, 55.00, 55.00, 49.50, 50.00,
     10.00, 'limit_up', TRUE, FALSE, FALSE, 0, 2,
     7000000, 3850000000, 7.5, 600000, '09:35:00',
     5500000, 6000000, '半导体,芯片,国产替代'),

    -- 半导体首板（炸板回封）
    ('2025-12-30', '688002.SH', '华虹半导体',
     2, '芯片产能紧张，价格上涨', '半导体',
     35.00, 38.50, 38.50, 34.20, 35.00,
     10.00, 'limit_up', FALSE, TRUE, TRUE, 2, 1,
     9000000, 3465000000, 12.5, 150000, '14:35:00',
     1200000, 1500000, '半导体,集成电路,晶圆代工'),

    -- 消费电子2连板
    ('2025-12-30', '002001.SZ', '立讯精密',
     6, '苹果新品发布，订单增加', '电子元件',
     28.00, 30.80, 30.80, 27.50, 28.00,
     10.00, 'limit_up', FALSE, FALSE, FALSE, 0, 2,
     5500000, 1694000000, 8.8, 400000, '10:45:00',
     3800000, 4000000, '消费电子,苹果概念,无线耳机'),

    -- 军工板块首板
    ('2025-12-30', '002002.SZ', '中航光电',
     3, '军工订单增加，业绩向好', '航空装备',
     45.00, 49.50, 49.50, 44.50, 45.00,
     10.00, 'limit_up', FALSE, FALSE, FALSE, 0, 1,
     3000000, 1485000000, 6.2, 250000, '13:45:00',
     2200000, 2500000, '军工,航空,连接器'),

    -- 医药板块（跌停）
    ('2025-12-30', '600004.SH', '恒瑞医药',
     4, '带量采购降价，业绩预期下调', '医药制造',
     50.00, 45.00, 50.50, 45.00, 50.00,
     -10.00, 'limit_down', FALSE, TRUE, FALSE, 1, 0,
     8000000, 3600000000, 10.5, 0, NULL,
     0, 0, '医药,创新药,医疗器械')
...
ON CONFLICT (trade_date, stock_code) DO UPDATE SET
    ...
    yesterday_auction_unmatched = EXCLUDED.yesterday_auction_unmatched,
